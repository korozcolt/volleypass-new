...
<head>
    ...
    <title>{{ $title ?? 'Dashboard Árbitro' }} - VolleyPass Sucre</title>
        ...
        <div class="fixed top-0 left-0 right-0 z-50 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 py-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-2">
                    <div class="w-8 h-8 bg-gradient-to-br from-green-600 to-blue-600 rounded-lg flex items-center justify-center">
                ...
                <div class="p-4 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex items-center space-x-3">
                        <div class="w-10 h-10 bg-gradient-to-br from-green-500 to-blue-600 rounded-full flex items-center justify-center">
                            <span class="text-white font-bold">{{ substr(Auth::user()->name ?? 'A', 0, 1) }}</span>
                        </div>
                        <div>
                            <p class="font-medium text-gray-900 dark:text-white">{{ Auth::user()->name ?? 'Árbitro' }}</p>
                            <p class="text-sm text-gray-500 dark:text-gray-400">Árbitro Certificado</p>
                        </div>
                    </div>
                </div>
                @livewire('shared.referee-navigation')
            </div>
        </div>
    </div>
