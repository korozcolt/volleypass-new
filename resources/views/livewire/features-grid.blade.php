<div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
    ...
    <div class="group bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 animate-on-scroll border border-gray-100 dark:border-gray-700">
        <div class="w-12 h-12 bg-{{ $feature['color'] }}-100 dark:bg-{{ $feature['color'] }}-900 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
            @switch($feature['icon'])
                @case('users')
